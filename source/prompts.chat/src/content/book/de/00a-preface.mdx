<div className="flex flex-col md:flex-row items-start gap-6 mb-8 p-6 bg-muted/50 rounded-lg">
  ...
  <div>
    ...
    <span className="block text-sm text-muted-foreground m-0!">
      Softwareentwickler aus Istanbul, tätig als Developer Advocate bei Automattic im WordPress-Team. Autor von Büchern über JavaScript und Prompt Engineering. Open-Source-Befürworter mit Spezialisierung auf Webtechnologien und KI-gestützte Entwicklung.
    </span>
