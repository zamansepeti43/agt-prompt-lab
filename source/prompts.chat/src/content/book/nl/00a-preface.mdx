<div className="flex flex-col md:flex-row items-start gap-6 mb-8 p-6 bg-muted/50 rounded-lg">
  ...
  <div>
    ...
    <span className="block text-sm text-muted-foreground m-0!">
      Softwareontwikkelaar uit Istanbul, werkzaam als Developer Advocate bij Automattic, in het WordPress-team. Auteur van boeken over JavaScript en prompt engineering. Open-source voorvechter met specialisatie in webtechnologieën en AI-ondersteunde ontwikkeling.
    </span>
