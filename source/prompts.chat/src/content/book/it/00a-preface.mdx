<div className="flex flex-col md:flex-row items-start gap-6 mb-8 p-6 bg-muted/50 rounded-lg">
  ...
  <div>
    ...
    <span className="block text-sm text-muted-foreground m-0!">
      Sviluppatore software di Istanbul, che lavora come Developer Advocate presso Automattic, nel team WordPress. Autore di libri su JavaScript e prompt engineering. Sostenitore dell'open-source specializzato in tecnologie web e sviluppo assistito dall'IA.
    </span>
