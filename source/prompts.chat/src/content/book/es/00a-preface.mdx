<div className="flex flex-col md:flex-row items-start gap-6 mb-8 p-6 bg-muted/50 rounded-lg">
  ...
  <div>
    ...
    <span className="block text-sm text-muted-foreground m-0!">
      Desarrollador de software de Estambul, trabajando como Developer Advocate en Automattic, en el equipo de WordPress. Autor de libros sobre JavaScript e ingeniería de prompts. Defensor del código abierto especializado en tecnologías web y desarrollo asistido por IA.
    </span>
