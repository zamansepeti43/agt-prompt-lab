<div className="flex flex-col md:flex-row items-start gap-6 mb-8 p-6 bg-muted/50 rounded-lg">
  ...
  <div>
    ...
    <span className="block text-sm text-muted-foreground m-0!">
      İstanbullu yazılım geliştirici, Automattic'te WordPress ekibinde Developer Advocate olarak çalışıyor. JavaScript ve prompt mühendisliği üzerine kitapların yazarı. Web teknolojileri ve yapay zeka destekli geliştirme konularında uzmanlaşmış açık kaynak savunucusu.
    </span>
