<div className="flex flex-col md:flex-row items-start gap-6 mb-8 p-6 bg-muted/50 rounded-lg">
  ...
  <div>
    ...
    <span className="block text-sm text-muted-foreground m-0!">
      Développeur logiciel d'Istanbul, travaillant comme Developer Advocate chez Automattic, dans l'équipe WordPress. Auteur de livres sur JavaScript et l'ingénierie des prompts. Défenseur de l'open source spécialisé dans les technologies web et le développement assisté par l'IA.
    </span>
