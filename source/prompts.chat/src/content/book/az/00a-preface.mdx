<div className="flex flex-col md:flex-row items-start gap-6 mb-8 p-6 bg-muted/50 rounded-lg">
  ...
  <div>
    ...
    <span className="block text-sm text-muted-foreground m-0!">
      İstanbuldan olan proqram tərtibatçısı, Automattic-in WordPress komandasında Developer Advocate kimi çalışır. JavaScript və prompt mühəndisliyi üzrə kitabların müəllifi. Veb texnologiyaları və süni intellekt dəstəkli inkişaf sahəsində ixtisaslaşmış açıq mənbə müdafiəçisi.
    </span>
